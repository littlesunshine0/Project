...
public struct NavigationKitContract: @unchecked Sendable {
    public static let shared = NavigationKitContract()
    ...
    private static func loadContract() -> PackageContract {
        ...
        return PackageContract(
            manifest: loadJSON(PackageManifestSchema.self, "Package.manifest", bundle) ?? PackageManifestSchema(id: "com.flowkit.navigationkit", name: "NavigationKit", category: PackageCategory.ui),
