...
public struct ExportKitContract: @unchecked Sendable {
    public static let shared = ExportKitContract()
    ...
    private static func loadContract() -> PackageContract {
        ...
        return PackageContract(
            manifest: loadJSON(PackageManifestSchema.self, "Package.manifest", bundle) ?? PackageManifestSchema(id: "com.flowkit.exportkit", name: "ExportKit", category: PackageCategory.utility),
