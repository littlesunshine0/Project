...
public struct DesignKitContract: @unchecked Sendable {
    public static let shared = DesignKitContract()
    ...
    private static func loadContract() -> PackageContract {
        ...
        return PackageContract(
            manifest: loadJSON(PackageManifestSchema.self, "Package.manifest", bundle) ?? PackageManifestSchema(id: "com.flowkit.designkit", name: "DesignKit", category: PackageCategory.ui),
