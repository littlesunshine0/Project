...
public struct AppIdeaKitContract: @unchecked Sendable {
    public static let shared = AppIdeaKitContract()
    ...
    private static func loadContract() -> PackageContract {
        ...
        return PackageContract(
            manifest: loadJSON(PackageManifestSchema.self, "Package.manifest", bundle) ?? PackageManifestSchema(id: "com.flowkit.appideakit", name: "AppIdeaKit", category: PackageCategory.content),
