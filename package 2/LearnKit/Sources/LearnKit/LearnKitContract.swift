...
public struct LearnKitContract: @unchecked Sendable {
    public static let shared = LearnKitContract()
    ...
    private static func loadContract() -> PackageContract {
        ...
        return PackageContract(
            manifest: loadJSON(PackageManifestSchema.self, "Package.manifest", bundle) ?? PackageManifestSchema(id: "com.flowkit.learnkit", name: "LearnKit", category: PackageCategory.content),
