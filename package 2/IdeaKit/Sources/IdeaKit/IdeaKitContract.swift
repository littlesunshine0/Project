...
public struct IdeaKitContract: @unchecked Sendable {
    public static let shared = IdeaKitContract()
    ...
    private static func loadContract() -> PackageContract {
        ...
        return PackageContract(
            manifest: loadJSON(PackageManifestSchema.self, "Package.manifest", bundle) ?? PackageManifestSchema(id: "com.flowkit.ideakit", name: "IdeaKit", category: PackageCategory.content),
