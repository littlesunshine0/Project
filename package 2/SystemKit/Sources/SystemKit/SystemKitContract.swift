...
public struct SystemKitContract: @unchecked Sendable {
    public static let shared = SystemKitContract()
    ...
    private static func loadContract() -> PackageContract {
        ...
        return PackageContract(
            manifest: loadJSON(PackageManifestSchema.self, "Package.manifest", bundle) ?? PackageManifestSchema(id: "com.flowkit.systemkit", name: "SystemKit", category: PackageCategory.core),
