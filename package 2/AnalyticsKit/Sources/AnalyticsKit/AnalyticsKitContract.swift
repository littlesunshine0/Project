...
public struct AnalyticsKitContract: @unchecked Sendable {
    public static let shared = AnalyticsKitContract()
    ...
    private static func loadContract() -> PackageContract {
        ...
        return PackageContract(
            manifest: loadJSON(PackageManifestSchema.self, "Package.manifest", bundle) ?? PackageManifestSchema(id: "com.flowkit.analyticskit", name: "AnalyticsKit", category: PackageCategory.analytics),
