...
public struct KnowledgeKitContract: @unchecked Sendable {
    public static let shared = KnowledgeKitContract()
    ...
    private static func loadContract() -> PackageContract {
        ...
        return PackageContract(
            manifest: loadJSON(PackageManifestSchema.self, "Package.manifest", bundle) ?? PackageManifestSchema(id: "com.flowkit.knowledgekit", name: "KnowledgeKit", category: PackageCategory.data),
