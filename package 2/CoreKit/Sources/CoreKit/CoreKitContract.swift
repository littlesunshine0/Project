...
public struct CoreKitContract: @unchecked Sendable {
    public static let shared = CoreKitContract()
    ...
    private static func loadContract() -> PackageContract {
        ...
        return PackageContract(
            manifest: loadJSON(PackageManifestSchema.self, "Package.manifest", bundle) ?? PackageManifestSchema(id: "com.flowkit.corekit", name: "CoreKit", category: PackageCategory.core),
