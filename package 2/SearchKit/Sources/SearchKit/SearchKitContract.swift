...
public struct SearchKitContract: @unchecked Sendable {
    public static let shared = SearchKitContract()
    ...
    private static func loadContract() -> PackageContract {
        ...
        return PackageContract(
            manifest: loadJSON(PackageManifestSchema.self, "Package.manifest", bundle) ?? PackageManifestSchema(id: "com.flowkit.searchkit", name: "SearchKit", category: PackageCategory.utility),
