...
public struct ParseKitContract: @unchecked Sendable {
    public static let shared = ParseKitContract()
    ...
    private static func loadContract() -> PackageContract {
        ...
        return PackageContract(
            manifest: loadJSON(PackageManifestSchema.self, "Package.manifest", bundle) ?? PackageManifestSchema(id: "com.flowkit.parsekit", name: "ParseKit", category: PackageCategory.utility),
