...
public struct ChatKitContract: @unchecked Sendable {
    public static let shared = ChatKitContract()
    ...
    private static func loadContract() -> PackageContract {
        ...
        return PackageContract(
            manifest: loadJSON(PackageManifestSchema.self, "Package.manifest", bundle) ?? PackageManifestSchema(id: "com.flowkit.chatkit", name: "ChatKit", category: PackageCategory.ai),
