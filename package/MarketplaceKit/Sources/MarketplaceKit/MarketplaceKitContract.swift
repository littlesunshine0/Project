...
public struct MarketplaceKitContract: @unchecked Sendable {
    public static let shared = MarketplaceKitContract()
    ...
    private static func loadContract() -> PackageContract {
        ...
        return PackageContract(
            manifest: loadJSON(PackageManifestSchema.self, "Package.manifest", bundle) ?? PackageManifestSchema(id: "com.flowkit.marketplacekit", name: "MarketplaceKit", category: PackageCategory.integration),
