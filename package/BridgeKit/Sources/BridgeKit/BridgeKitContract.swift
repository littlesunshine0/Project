...
public struct BridgeKitContract: @unchecked Sendable {
    public static let shared = BridgeKitContract()
    ...
    private static func loadContract() -> PackageContract {
        ...
        return PackageContract(
            manifest: loadJSON(PackageManifestSchema.self, "Package.manifest", bundle) ?? PackageManifestSchema(id: "com.flowkit.bridgekit", name: "BridgeKit", category: PackageCategory.integration),
