...
public struct IndexerKitContract: @unchecked Sendable {
    public static let shared = IndexerKitContract()
    ...
    private static func loadContract() -> PackageContract {
        ...
        return PackageContract(
            manifest: loadJSON(PackageManifestSchema.self, "Package.manifest", bundle) ?? PackageManifestSchema(id: "com.flowkit.indexerkit", name: "IndexerKit", category: PackageCategory.data),
