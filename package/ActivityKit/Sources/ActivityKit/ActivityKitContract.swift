...
public struct ActivityKitContract: @unchecked Sendable {
    public static let shared = ActivityKitContract()
    ...
    private static func loadContract() -> PackageContract {
        ...
        return PackageContract(
            manifest: loadJSON(PackageManifestSchema.self, "Package.manifest", bundle) ?? PackageManifestSchema(id: "com.flowkit.activitykit", name: "ActivityKit", category: PackageCategory.social),
