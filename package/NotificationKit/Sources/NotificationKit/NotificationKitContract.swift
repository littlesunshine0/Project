...
public struct NotificationKitContract: @unchecked Sendable {
    public static let shared = NotificationKitContract()
    ...
    private static func loadContract() -> PackageContract {
        ...
        return PackageContract(
            manifest: loadJSON(PackageManifestSchema.self, "Package.manifest", bundle) ?? PackageManifestSchema(id: "com.flowkit.notificationkit", name: "NotificationKit", category: PackageCategory.utility),
