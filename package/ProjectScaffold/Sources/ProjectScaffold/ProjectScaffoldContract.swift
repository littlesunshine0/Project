...
public struct ProjectScaffoldContract: @unchecked Sendable {
    public static let shared = ProjectScaffoldContract()
    ...
    private static func loadContract() -> PackageContract {
        ...
        return PackageContract(
            manifest: loadJSON(PackageManifestSchema.self, "Package.manifest", bundle) ?? PackageManifestSchema(id: "com.flowkit.projectscaffold", name: "ProjectScaffold", category: PackageCategory.utility),
