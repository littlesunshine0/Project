...
public struct NLUKitContract: @unchecked Sendable {
    public static let shared = NLUKitContract()
    ...
    private static func loadContract() -> PackageContract {
        ...
        return PackageContract(
            manifest: loadJSON(PackageManifestSchema.self, "Package.manifest", bundle) ?? PackageManifestSchema(id: "com.flowkit.nlukit", name: "NLUKit", category: PackageCategory.ai),
