...
public struct ContentHubContract: @unchecked Sendable {
    public static let shared = ContentHubContract()
    ...
    private static func loadContract() -> PackageContract {
        ...
        return PackageContract(
            manifest: loadJSON(PackageManifestSchema.self, "Package.manifest", bundle) ?? PackageManifestSchema(id: "com.flowkit.contenthub", name: "ContentHub", category: PackageCategory.content),
