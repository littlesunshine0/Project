...
public struct ErrorKitContract: @unchecked Sendable {
    public static let shared = ErrorKitContract()
    ...
    private static func loadContract() -> PackageContract {
        ...
        return PackageContract(
            manifest: loadJSON(PackageManifestSchema.self, "Package.manifest", bundle) ?? PackageManifestSchema(id: "com.flowkit.errorkit", name: "ErrorKit", category: PackageCategory.utility),
