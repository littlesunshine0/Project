...
public struct SyntaxKitContract: @unchecked Sendable {
    public static let shared = SyntaxKitContract()
    ...
    private static func loadContract() -> PackageContract {
        ...
        return PackageContract(
            manifest: loadJSON(PackageManifestSchema.self, "Package.manifest", bundle) ?? PackageManifestSchema(id: "com.flowkit.syntaxkit", name: "SyntaxKit", category: PackageCategory.utility),
