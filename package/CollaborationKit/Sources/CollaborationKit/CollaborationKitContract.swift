...
public struct CollaborationKitContract: @unchecked Sendable {
    public static let shared = CollaborationKitContract()
    ...
    private static func loadContract() -> PackageContract {
        ...
        return PackageContract(
            manifest: loadJSON(PackageManifestSchema.self, "Package.manifest", bundle) ?? PackageManifestSchema(id: "com.flowkit.collaborationkit", name: "CollaborationKit", category: PackageCategory.social),
