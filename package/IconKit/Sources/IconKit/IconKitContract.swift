...
public struct IconKitContract: @unchecked Sendable {
    public static let shared = IconKitContract()
    ...
    private static func loadContract() -> PackageContract {
        ...
        return PackageContract(
            manifest: loadJSON(PackageManifestSchema.self, "Package.manifest", bundle) ?? PackageManifestSchema(id: "com.flowkit.iconkit", name: "IconKit", category: PackageCategory.ui),
