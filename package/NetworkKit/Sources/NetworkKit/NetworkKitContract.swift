...
public struct NetworkKitContract: @unchecked Sendable {
    public static let shared = NetworkKitContract()
    ...
    private static func loadContract() -> PackageContract {
        ...
        return PackageContract(
            manifest: loadJSON(PackageManifestSchema.self, "Package.manifest", bundle) ?? PackageManifestSchema(id: "com.flowkit.networkkit", name: "NetworkKit", category: PackageCategory.integration),
